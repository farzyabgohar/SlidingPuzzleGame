...
public class GameBoard {
    ...
    public GamePiece pieceAt(int x, int y) {
        for (int i = 0; i < numGamePieces; i++) {
            if (gamePieces[i].topLeftX == x && gamePieces[i].topLeftY == y) {
                return gamePieces[i];
            } else if (gamePieces[i].topLeftX == x && ((y < gamePieces[i].topLeftY + gamePieces[i].height) && (y > gamePieces[i].topLeftY))) {
                return gamePieces[i];
            } else if (gamePieces[i].topLeftY == y && ((x < gamePieces[i].topLeftX + gamePieces[i].width) && (x > gamePieces[i].topLeftX))) {
                return gamePieces[i];
            }
        }
        return null;
